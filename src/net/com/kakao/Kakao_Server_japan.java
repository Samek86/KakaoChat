...
public class Kakao_Server_japan implements Runnable, KeyListener, ActionListener {
	protected static final Component INFORMATION_MESSAGE = null;
	Dimension scr = Toolkit.getDefaultToolkit().getScreenSize();
	int scW = (int) scr.getWidth();
	int scH = (int) scr.getHeight();
	ImageIcon gongji = new ImageIcon("Image/gongjij.png");
	...
	public static void main(String[] args) {
		new Thread(new Kakao_Server_japan()).start();
